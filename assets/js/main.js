    ...
    var t = {
        headerOptionsDropdown: function () {
            s(".tm-dropdown > button").on("click", function () {
                s(this).siblings("ul").slideToggle(), s(this).parent(".tm-dropdown").siblings(".tm-dropdown").children("ul").slideUp()
            })
        },
        ...
        sliderActivations: {
            ...
            init: function () {
                this.herosliderSliderActivation(), this.productsSliderActivation(), this.similliarProductSlider(), this.brandlogoSliderActivation(), this.teamMemberSlider(), this.productDetailsGallery(), this.blogSliderActivation()
            }
        },
        ...
        stickyHeader: function () {
            if (s(".tm-header-sticky").exists()) {
                ...
                s(".tm-heroslider-area, .tm-breadcrumb-area").css({
                    ...
                    550 < s(this).scrollTop() ? s(".tm-header").addClass("is-sticky") : s(".tm-header").removeClass("is-sticky")
                })
            }
        },
        ...
        productChangeView: function () {
            s(".tm-shop-productview").on("click", "button", function (t) {
                ...
                s(this).addClass("active").siblings().removeClass("active"), "list" === e ? s(".tm-shop-products").addClass("list-view") : s(".tm-shop-products").removeClass("list-view")
            })
        },
        init: function () {
            t.headerOptionsDropdown(), t.databgImage(), t.meanmenuActivation(), t.niceSelectActive(), t.countdownActivation(), t.sliderActivations.init(), t.fancyboxSlick(), t.ajaxMailchimp(), t.stickyHeader(), t.scrollToTop(), t.herosliderHeight(), t.rangeSlider(), t.productRatingInput(), t.productQuantityBox(), t.instafeedActive(), t.scrollAnimation(), t.differentAddressFormToggle(), t.checkoutPaymentMethod(), t.loginPassShower(), t.menuOverflow(), t.dropdownHasChildren(), t.ajaxContactForm(), t.portfolioFilter(), t.productChangeView()
        }
    };
    t.init()
}(jQuery);